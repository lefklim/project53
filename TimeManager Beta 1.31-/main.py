...
######### Main Menu #########
    ...
    def graphFunction(self, totaltime, lei, com):
        ...
        if len(lei) != 0:
            ...
            ax[0].set_title("Δραστηριότητες Ελεύθερου Χρόνου", wrap=True, fontsize=10)  # Set the title for the Leisure subplot
        ...
        # Wrap the labels of each activity to a new line with a maximum of two words per line
        for text in texts:
