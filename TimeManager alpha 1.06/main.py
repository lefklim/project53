    ...
    def databaseSelect(self,insertedList):
        ...
        if not insertedList:
            ...
            try:
                ...
                # Calculating activity stats
                meanCommitment,meanLeisure,timeCommitment,timeLeisure = self.calculateData(self.graphVariable[0])

                self.entryList[11]['text'] = meanCommitment
                self.entryList[10]['text'] = meanLeisure
                self.entryList[9]['text'] = timeCommitment
                self.entryList[8]['text'] = timeLeisure
